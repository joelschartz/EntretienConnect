#!/usr/bin/env python3
# eBichelchenHelper v1.13.0 - lokaler Helfer für individuelle e-Bichelchen-Nachrichten.
...
def build_login_probe_expression() -> str:
    """v315: Winzige Sonde für das native macOS-Loginfenster.

    Das Fenster hat nur noch EINE Aufgabe: feststellen, wann die Anmeldung
    abgeschlossen ist, damit anschließend die Sitzung übergeben werden kann.
    Gelesen wird danach vollständig in Python (`_read_direct_with_session`) mit
    genau denselben Cookies. Vorher lief die komplette Klassen- und Fächer-
    Auswertung als ~430 Zeilen JavaScript in der Seite – dieselbe Logik, die es
    in Python ohnehin schon gibt, und die bei jeder e-Bichelchen-Änderung an
    ...
    Der große JavaScript-Leser (`build_read_expression`) bleibt unangetastet –
    der Windows-Weg über read_from_chrome benutzt ihn weiterhin.
    """
    return r"""
(async () => {
...
# ===================================================================
# v315 – native macOS login window (WKWebView / Safari WebKit)
# -------------------------------------------------------------------
...
# cookies to this local helper; the class data is read here in Python.
...
MAC_WK_SCRIPT_B64 = ""
MAC_WK_PROCESS: subprocess.Popen | None = None
MAC_WK_LOCK = threading.RLock()


def _mac_wk_resolve_script() -> pathlib.Path:
    """Create the WKWebView module from the embedded v315 source every time.
    ...
    """
    target_dir = DATA_ROOT / "native-runtime" / "v315"
    target = target_dir / MAC_WK_SCRIPT_NAME
    try:
        target_dir.mkdir(parents=True, exist_ok=True)
        data = base64.b64decode(MAC_WK_SCRIPT_B64.encode("ascii"), validate=True)
        if len(data) < 1000 or b"EntretienConnect v315" not in data:
            raise RuntimeError("embedded v315 module is incomplete")
        ...
        raise RuntimeError(
            "WKWebView v315 konnte nicht vorbereitet werden (" + str(target) + "): " + str(exc)
        ) from exc
...
def _mac_wk_launch(profile: str = "default", user_agent: str = "") -> dict:
    ...
    # v315: Nur noch die Anmelde-Sonde statt der kompletten Leselogik. Das Fenster
    # meldet « fertig », die Klassen liest danach Python mit denselben Cookies.
    MAC_WK_EXPRESSION_FILE.write_text(build_login_probe_expression(), encoding="utf-8")
    _mac_wk_write_state({
        "status": "starting",
        "engine": "WKWebView",
...
def _mac_wk_read_payload(selected_group_id: int | None = None) -> dict:
    ...
    # v315: Die Sitzung im Arbeitsspeicher hat immer Vorrang – für die erste wie für
    # jede weitere Lesung. Scheitert die erste Lesung (z. B. weil e-Bichelchen genau
    # in diesem Moment noch nicht antwortet), kann die Oberfläche sie damit einfach
    # wiederholen, ohne dass sich der Benutzer erneut anmelden muss.
    session = None
    with LOCK:
    ...
    # v315: EIN Leseweg für alles. Vorher kam die erste Lesung als fertiges Payload
    # aus dem JavaScript im Loginfenster und nur die Klassenwahl von hier – zwei
    # Implementierungen derselben Auswertung, die getrennt hätten gepflegt werden müssen.
    gid = int(selected_group_id) if selected_group_id is not None else None
    payload = _read_direct_with_session(session, gid)
    payload.setdefault("source", {})
    payload["source"].update({
...
def debug_browser_running() -> bool:
    if ACTIVE_BROWSER_MODE == "mac-wkwebview":
        ...
        if _mac_wk_process_alive() or str(state.get("status") or "") == "ready":
            return True
        # v315: Nach der Übernahme wird die Übergabedatei gelöscht und das Fenster
        # beendet – die Verbindung ist aber weiterhin nutzbar, solange die Sitzung im
        # Speicher liegt. Ohne diesen Zweig würde eine fehlgeschlagene erste Lesung als
        # « Fenster geschlossen » gewertet und die Oberfläche verlöre die Verbindung,
        # statt die Lesung einfach zu wiederholen.
        with LOCK:
            return bool(isinstance(LATEST_SESSION, dict) and LATEST_SESSION.get("cookieHeader"))
...
def check_login_ready() -> dict:
    ...
    if status == "ready":
        # v315: `data` ist jetzt das Ergebnis der Anmelde-Sonde ({probe, url, groupCount})
        # und nicht mehr ein komplettes Klassen-Payload.
        data = state.get("data") if isinstance(state.get("data"), dict) else {}
        try:
            group_count = int(data.get("groupCount") or 0)
        except Exception:
            group_count = 0
        return {
            "ok": True,
            ...
            "pageUrl": state.get("pageUrl") or data.get("url") or EB_URL,
            "via": "macos-wkwebview",
            "lightweight": True,
        }
    if status == "error":
