#!/usr/bin/env python3
# eBichelchenHelper v1.15.0 - lokaler Helfer für individuelle e-Bichelchen-Nachrichten.
...
def _read_direct_with_session(session: dict, selected_group_id: int | None = None) -> dict:
...
# ===================================================================
# v325 – native macOS login window (WKWebView / Safari WebKit)
# -------------------------------------------------------------------
...
MAC_WK_SCRIPT_B64 = ""
MAC_WK_PROCESS: subprocess.Popen | None = None
MAC_WK_LOCK = threading.RLock()


def _mac_wk_resolve_script() -> pathlib.Path:
    """Create the WKWebView module from the embedded v325 source every time.
    ...
    """
    target_dir = DATA_ROOT / "native-runtime" / "v325"
    target = target_dir / MAC_WK_SCRIPT_NAME
    try:
        target_dir.mkdir(parents=True, exist_ok=True)
        data = base64.b64decode(MAC_WK_SCRIPT_B64.encode("ascii"), validate=True)
        if len(data) < 1000 or b"EntretienConnect v325" not in data:
            raise RuntimeError("embedded v325 module is incomplete")
        ...
        raise RuntimeError(
            "WKWebView v325 konnte nicht vorbereitet werden (" + str(target) + "): " + str(exc)
        ) from exc
...
def _mac_wk_save_session(session: dict) -> None:
    ...
    try:
        ...
        if not slim:
            return
        _write_private_text(MAC_WK_SAVED_SESSION_FILE, json.dumps(
            {"savedAt": time.time(), "cookies": slim}, ensure_ascii=False))
    except Exception:
        pass
...
def _mac_wk_prepare_restore_cookies() -> str:
    """Schreibt die gespeicherten Cookies für das Loginfenster bereit (v325).

    Gibt den Dateipfad zurück, wenn eine noch gültige Sitzung existiert, sonst "".
    Zu alte Sitzungen werden verworfen – eine abgelaufene IAM-Sitzung würde ohnehin
    nur auf der Anmeldeseite landen.
    """
    try:
        ...
        return str(MAC_WK_RESTORE_COOKIES_FILE)
    except Exception:
        return ""
...
def _mac_wk_launch(profile: str = "default", user_agent: str = "") -> dict:
    ...
    restore_path = _mac_wk_prepare_restore_cookies()
    args = [
        "/usr/bin/osascript",
        "-l", "JavaScript",
        str(script_file),
...
def _mac_wk_read_payload(selected_group_id: int | None = None) -> dict:
    ...
    if session is None:
        ...
        # v325: Sitzung für den nächsten App-Start merken (Cookies, 0600, 12 h gültig).
        _mac_wk_save_session(session)
